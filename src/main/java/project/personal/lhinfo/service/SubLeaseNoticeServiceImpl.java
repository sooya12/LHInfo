...
public class SubLeaseNoticeServiceImpl implements SubLeaseNoticeService {
    ...
    @Override
    public List<SubLeaseNoticeDto> subLeaseNoticeList() throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("PAN_NM","UTF-8") + "=" + URLEncoder.encode("", "UTF-8")); /*공고명으로 조회*/
        urlBuilder.append("&" + URLEncoder.encode("UPP_AIS_TP_CD","UTF-8") + "=" + URLEncoder.encode("01", "UTF-8")); /*공고유형코드*/
