...
public class LHNoticeServiceImpl implements LHNoticeService {
    ...
    @Override
    public List<LHNoticeDto> lhNoticeList() throws IOException {
...
//        urlBuilder.append("&" + URLEncoder.encode("BBS_TL", "UTF-8") + "=" + URLEncoder.encode("결과", "UTF-8")); /*검색어-제목*/
//        urlBuilder.append("&" + URLEncoder.encode("BBS_DTL_CTS", "UTF-8") + "=" + URLEncoder.encode("현황", "UTF-8")); /*검색어-내용*/
//        urlBuilder.append("&" + URLEncoder.encode("UPP_AIS_TP_CD", "UTF-8") + "=" + URLEncoder.encode("01", "UTF-8")); /*상위유형코드 토지,분양주택,신혼희망타운,임대주택,매입임대/전세임대,상가,기타*/
