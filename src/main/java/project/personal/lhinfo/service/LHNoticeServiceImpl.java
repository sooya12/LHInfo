...
public class LHNoticeServiceImpl implements LHNoticeService {
    ...
    public List<LHNoticeDto> lhNoticeList(LHNoticeSearchDto lhNoticeSearchDto) throws IOException {
        ...
        if(!"".equals(lhNoticeSearchDto.getEndDate())) {
            urlBuilder.append("&" + URLEncoder.encode("SCH_ED_DT", "UTF-8") + "=" + URLEncoder.encode(lhNoticeSearchDto.getEndDate(), "UTF-8")); /*기간검색-종료일*/
        }
